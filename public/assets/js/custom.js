                        ...
                        if (response.success && response.services) {
                            ...
                            services.forEach((service, index) => {
                                ...
                                if (service.sale_price) {
                                    ...
                                    priceDisplay =
                                        `<span class="text-decoration-line-through text-muted">${service.price}</span> <span class=" fw-bold">Pago en transferencia bancaria: ${service.sale_price}</span>`;
                                } else {
                                    // If no sale price, just show regular price normally
                                    priceDisplay =
                                        `<span class="fw-bold">Pago en transferencia bancaria: ${service.price}</span>`;
                                }
